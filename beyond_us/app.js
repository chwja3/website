    ...
    const COMING_SOON_INFO = {
      ...
      pilgrim: {
        date: '6/21 Open',
        title: '천로역정',
        description: '천로역정이란 영국의 신학자이자 작가 존 번연이 쓴 기독교 소설로,\n한 순례자가 멸망의 도시를 떠나 천성을 향해 걸어가는 믿음의 여정을 그린 이야기입니다.\n\n필그림 하우스의 천로역정은 이 여정 공간으로 옮겨놓은 곳입니다.\n\n그 여정을 따라 잠시 멈추고 머물며, 쉼을 누려보세요.',
        note: '나에게 배정된 천로역정 스팟 2곳을 인증하면\n특별한 레어카드를 받을 수 있습니다.\n🎁✨',
      },
      chat: {
        date: 'Coming Soon',
        title: '채팅방',
