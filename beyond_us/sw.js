const CACHE = 'beyondus-20260518ac';
const ASSETS = [
  './',
  './index.html',
  './app.html',
  ...
  './images/앤뒷모습.png',
  './images/sheep.png',
  './images/앤카드사랑최최종.webp',
  './images/앤카드희락최최종.webp',
  './images/앤카드화평최최종.webp',
  './images/앤카드오래참음최최종.webp',
  './images/앤카드자비최최종.webp',
  './images/앤카드양선최최종.webp',
  './images/앤카드충성최최종.webp',
  './images/앤카드온유최최종.webp',
  './images/앤카드절제최최종.webp',
];
